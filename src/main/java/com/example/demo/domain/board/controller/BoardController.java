...
import com.example.demo.domain.board.data.dto.response.BoardUpdateResponse;
...
public class BoardController {
    ...
    public ResponseEntity<BoardWriteResponse> writeBoard(@RequestBody BoardWriteRequest boardCreateRequest) {
        return new ResponseEntity<>(boardService.boardWrite(boardCreateRequest), HttpStatus.CREATED);
    }
